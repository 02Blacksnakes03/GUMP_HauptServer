...
AddEventHandler("esx_swiatla:otworz", function()
	...
	if IsPedInVehicle(ped, car, false) then
		...
		ESX.ShowAdvancedNotification('Swiatła', '', "Man muss im Auto sitzen, um die Farbe der Lichter zu ändern", pic, 1)
	end
end)
...
RegisterNUICallback('save', function(data, cb)
	...
	ESX.TriggerServerCallback("esx_swiatla:zapisz_swiatla", function(isPurchasable)
		if isPurchasable then
			ESX.ShowAdvancedNotification('Swiatła', '', "Die Glühbirnen sind eingebaut.", pic, 1)
		else
			ESX.ShowAdvancedNotification('Swiatła', '', "Es ist ein Fehler aufgetreten", pic, 1)
		end
