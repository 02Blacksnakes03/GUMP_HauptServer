...
-- You can disable the Favorite emote keybinding here.
	...
	FavKeybind = 19, -- Get the button number here https://docs.fivem.net/game-references/controls/
-- You can change the header image for the f3 menu here
-- Use a 512 x 128 image!
-- NOte this might cause an issue of the image getting stuck on peoples screens
	CustomMenuEnabled = false,
	MenuImage = "https://i.imgur.com/9W1Fq6K.png",
...
Config.Languages = {
  ...
  ['en'] = {
        ...
        ['newsetemote'] = "~w~ ist jetzt dein gebundenes Emote, drücke ~g~LEFT ALT~w~, um es zu verwenden.",
