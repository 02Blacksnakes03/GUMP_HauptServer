...
--	Craft = {
--		Pos   = { x = -000.000, y = -000.000, z = -000.000 },
--		Size  = { x = 1.5, y = 1.5, z = 1.0 },
--		Color = { r = 204, g = 204, b = 0 },
--		Type  = -1
--	},
...
--	VehicleSpawnPoint = {
--		Pos   = { x = -200.53, y = -1303.49, z = 31.25 },
--		Size  = { x = 1.5, y = 1.5, z = 1.0 },
--		Type  = -1
--	},

--	VehicleDeleter = {
--		Pos   = { x = -194.73, y = -1306.85, z = 31.28 },
