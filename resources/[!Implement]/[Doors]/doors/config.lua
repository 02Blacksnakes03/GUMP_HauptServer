...
Labels = {
  ...
  do_unlock         = "",
  do_lock           = "",
  access_granted    = "~g~Zugang gewährt.~s~",
  access_denied     = "~r~Zugang verwährt.~s~",
  key_shop_3dtxt    = "[~g~E~s~] Schlüssel Shop",
  key_shop_helptxt  = "~INPUT_PICKUP~ Schlüssel Shop",
  key_shop_bliptxt  = "Schlüssel Shop",
  no_bank_acc       = "Es wurde kein BAnk Konto gefunden.",
  police_warning    = "Es bricht jemand ein in %s. \nDrücke ~INPUT_PICKUP~ um das GPS zu setzen."
}
