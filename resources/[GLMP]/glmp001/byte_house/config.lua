...
Config = {
    ...
    Houses = { -- ALWAYS add a new house at the bottom of this list. Adding it at the top will just ruin the housing system! If you don't know what you're doing, DON'T DO ANYTHING!
        ...
        {['prop'] = 'mansion', ['door'] = vector3(-877.24, 306.69, 84.15), ['price'] = 1250000},        --   Nikolaj
        {['prop'] = 'mansion', ['door'] = vector3(-881.41, 363.7, 85.36), ['price'] = 1250000},         --   Rachel
        {['prop'] = 'mansion', ['door'] = vector3(-1580.63, -34.09, 57.57), ['price'] = 12500},
        {['prop'] = 'lomda_nice', ['door'] = vector3(-35.65, 2871.65, 59.61), ['price'] = 12500},  
        {['prop'] = 'mansion', ['door'] = vector3(-747.35, 808.15, 215.15), ['price'] = 12500}, 
        {['prop'] = 'nice', ['door'] = vector3(3310.73, 5176.42, 19.61), ['price'] = 12500},
        {['prop'] = 'mansion', ['door'] = vector3(-949.29, 196.98, 67.39), ['price'] = 12500}, 
        ...
        {['prop'] = 'mansion', ['door'] = vector3(-842.28, -25.21, 40.4), ['price'] = 5000},
        {['prop'] = 'mansion', ['door'] = vector3(-930.31, 19.39, 48.53), ['price'] = 5000},
        {['prop'] = 'kinda_nice', ['door'] = vector3(-224.96, -1654.02, 37.64), ['price'] = 500},
        {['prop'] = 'kinda_nice', ['door'] = vector3(-224.06, -1648.48, 38.44), ['price'] = 500},
        {['prop'] = 'kinda_nice', ['door'] = vector3(-216.61, -1648.42, 37.64), ['price'] = 500},
        {['prop'] = 'kinda_nice', ['door'] = vector3(-212.19, -1660.62, 37.64), ['price'] = 500},
        {['prop'] = 'kinda_nice', ['door'] = vector3(-212.19, -1668.04, 37.64), ['price'] = 500},
...
Strings = {
    ['Press_E'] = 'Drücke ~INPUT_CONTEXT~ um %s',
    ['Furniture_Categories'] = 'Kategorien',
    ['Manage_House'] = 'Verwalten Sie Ihr Haus',
    ['Buy_House'] = 'Kaufe Haus #%s',
    ['Knock_House'] = 'an die Tür klopfen',
    ['Your_House'] = 'Dein Haus',
    ['Buyable_House'] = 'Buyable house',
    ['Player_House'] = 'Kaufbares Haus',
    ['Storage'] = 'Zugriff auf Ihren Keller',
    ['Sell_House'] = 'Verkaufen für $%s',
    ['Enter_House'] = 'Betrete Haus',
    ['Sell_Confirm'] = 'Verkaufen Sie iher Haus für $%s?',
    ['yes'] = 'Ja',
    ['no'] = 'Nein',
    ['Sold_House'] = 'Sie haben Ihr Haus für $%s',
    ['Must_Sell'] = 'Sie können nur ein Haus besitzen. Verkaufen Sie Ihr Haus, um dieses zu kaufen.',
    ['Buy_House_Confirm'] = 'Haus Kaufen #%s für $%s?',
    ['Manage_Door'] = 'Tür verwalten',
    ['Accept'] = 'Akzeptieren Sie jemanden, der einreisen soll',
    ['Exit'] = 'Haus Verlassen',
    ['Noone_Home'] = 'Niemand Zuhause!',
    ['Someone_Knocked'] = 'Jemand klopfte an. Gehe zur Tür, um sie hereinzulassen!',
    ['Let_In'] = 'Lassen Sie jemanden herein',
    ['Accept_Player'] = 'Hinein %s lassen ?',
    ['Waiting_Owner'] = 'Warten auf den Hausbesitzer, um Sie hereinzulassen.',
    ['ikea'] = 'IKEA',
    ['Buy_Furniture'] = 'Eingeben IKEA',
    ['Buying_Furniture'] = '~INPUT_FRONTEND_LEFT~ ~INPUT_FRONTEND_RIGHT~ browse\n~INPUT_CELLPHONE_DOWN~ ~INPUT_CELLPHONE_UP~ Änderungskategorie (%s)\n~INPUT_FRONTEND_RDOWN~ Kaufen %s für $%s\n~INPUT_MOVE_UP_ONLY~ ~INPUT_MOVE_DOWN_ONLY~ ~INPUT_VEH_CINEMATIC_UP_ONLY~ ~INPUT_VEH_CINEMATIC_DOWN_ONLY~ adjust camera\n~INPUT_MOVE_LEFT_ONLY~ ~INPUT_MOVE_RIGHT_ONLY~ rotate\n\n~INPUT_FRONTEND_RRIGHT~ verlassen',
    ['Confirm_Purchase'] = 'Kaufen %s für $%s?',
    ['no_money'] = "Du hast nicht genügent Geld",
    ['Bought_Furniture'] = 'Gekauft1x %s für $%s',
    ['Furnish'] = 'Möblieren dir dein Haus',
    ['Store_Garage'] = 'drücke ~INPUT_CONTEXT~ um das Fahrzeug aufzubewahren', 
    ['Re_Furnish'] = 'Entfernt platzierte Möbel',
    ['Remove'] = 'Entfernt %s (#%s)',
    ['Amount'] = 'Wie viele?',
    ['Player_Inventory'] = 'Dein Inventar',
    ['House_Inventory'] = 'Inventar',
    ['Invalid_Amount'] = 'Ungültiger Betrag. Bitte geben Sie eine Nummer.',
    ['Store'] = 'Store',
    ['Withdraw'] = 'Herrausnehmen',
    ['Storage_Title'] = 'Hineinlegen',
    ['You_Stored'] = 'Du hast etwas hineingelegt! %sx %s',
    ['You_Withdrew'] = 'Du hast etwas herrausgenommen! %sx %s',
    ['Not_Enough'] = 'Du hast nicht so viele!',
    ['Not_Enough_House'] = 'Es gibt nicht so viele im Keller!',
    ['Weapons'] = 'Waffen',
    ['Items'] = 'Items',
    ['No_Weapon'] = 'Du hast diese Waffe nicht auf dir!',
    ['bullets'] = 'Kugeln', 
    ['Rotation'] = 'Drehung',
    ['Guests'] = 'Ihre Gäste müssen das Haus verlassen, bevor Sie dies tun können.',
    ['Garage'] = 'In der Garage',
    ['No_Spawn'] = 'Es konnte kein Spawnpoint für Ihr Haus gefunden werden.',
    ['Host_Left'] = 'Der Hausbesitzer verließ den Server, Sie wurden aus ihrem Haus geworfen.',
    ['No_Money'] = 'Sie haben nicht genug Geld!',
    ['Furnishing'] = '~INPUT_CELLPHONE_LEFT~ ~INPUT_CELLPHONE_RIGHT~ ~INPUT_CELLPHONE_DOWN~ ~INPUT_CELLPHONE_UP~ move\n~INPUT_VEH_CINEMATIC_UP_ONLY~ ~INPUT_VEH_CINEMATIC_DOWN_ONLY~ height\n~INPUT_ATTACK~ ~INPUT_AIM~ rotate\n~INPUT_DETONATE~ Platz auf dem Boden\n~INPUT_FRONTEND_ENDSCREEN_ACCEPT~ Platziere\n~INPUT_FRONTEND_CANCEL~ Verlassen'
}