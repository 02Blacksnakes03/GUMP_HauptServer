...
--Für Beamte
RegisterServerEvent("bens_cuff_item:uncufffürbeamte")
AddEventHandler("bens_cuff_item:uncufffürbeamte",function(player)
    local _source = source
    local xPlayer = ESX.GetPlayerFromId(_source)
    cuffed[player]=false
    TriggerClientEvent('bens_cuff_item:forceUncuff', player)
...
RegisterServerEvent('cuffnotify')
AddEventHandler('cuffnotify', function(player, msg)

    TriggerClientEvent('glmp_singlenotify', player, '', msg)
end)
