...
RegisterNetEvent('yeavn:openTrunk')
AddEventHandler('yeavn:openTrunk', function()
  openmenuvehicle()
end)
      ...
      if vehFront > 0 and closecar ~= nil and GetPedInVehicleSeat(closecar, -1) ~= GetPlayerPed(-1) then
        ...
        if ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'inventory') then
          ...
          if locked == 1 or class == 15 or class == 16 or class == 14 then
            ...
            TriggerEvent('glmp_notify', 'red', 'Kofferraum', 'Dieser kofferraum ist geschlossen')
            --print('Trunk has been closed.')
          end
        end
      else
        TriggerEvent('glmp_notify', 'red', 'Kofferraum', 'Kein Fahrzeug in der Nähe')
